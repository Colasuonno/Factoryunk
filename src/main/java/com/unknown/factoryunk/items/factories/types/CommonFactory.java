...
public class CommonFactory extends Factory {
    ...
    public CommonFactory(Plugin plugin, String lastSchem, int itemsCollected, long created, UUID owner, Location blockLocation, Set<UUID> admins, Material material, int health, FactoryType type, Location center, Location pos1, Location pos2) {
        super(plugin, lastSchem, itemsCollected, created, owner, blockLocation, admins, material, health, type, center, pos1, pos2);
        setDelayInMillis(5000L);
    }
