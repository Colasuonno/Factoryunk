...
public class StringUtils {
    ...
    private final static String PREFIX = ChatColor.BLACK + "[" + ChatColor.GOLD + "FactoryUnk" + ChatColor.BLACK + "]";
    ...
    public static void e(String message, CommandSender sender, Object... args) {
        if (StringUtils.parseString(message, args).endsWith(".") || StringUtils.parseString(message, args).endsWith("!") || StringUtils.parseString(message, args).endsWith("?")) {
            sender.sendMessage(PREFIX + ChatColor.RED + " " + StringUtils.parseString(message, args));
            return;
        }
        sender.sendMessage(PREFIX + ChatColor.RED + " " + StringUtils.parseString(message, args) + ".");
    }

    public static void e(String message, CommandSender sender) {
        if (StringUtils.parseString(message).endsWith(".") || StringUtils.parseString(message).endsWith("!") || StringUtils.parseString(message).endsWith("?")) {
            sender.sendMessage(PREFIX + ChatColor.RED + " " + StringUtils.parseString(message));
            return;
        }
        sender.sendMessage(PREFIX + ChatColor.RED + " " + StringUtils.parseString(message) + ".");
    }

    public static void i(String message, Set<UUID> sender, Object... args) {
        if (StringUtils.parseString(message, args).endsWith(".") || StringUtils.parseString(message, args).endsWith("!") || StringUtils.parseString(message, args).endsWith("?")) {
            sender.forEach(senders -> {
                if (Bukkit.getOfflinePlayer(senders).isOnline()) {
                    Bukkit.getPlayer(senders).sendMessage(PREFIX + " " + StringUtils.parseString(message, args));
                }
            });
            return;
        }
    ...
    public static void i(String message, CommandSender target, Object... args) {
        if (StringUtils.parseString(message, args).endsWith(".") || StringUtils.parseString(message, args).endsWith("!") || StringUtils.parseString(message, args).endsWith("?")) {
            target.sendMessage(StringUtils.parseString(message, args));
            return;
        }
