...
import com.unknown.factoryunk.utils.ReflectionUtil;
...
public class CommandManager {
    ...
    public void enable(){
        try {
            ...
            for (ClassPath.ClassInfo info : path.getTopLevelClassesRecursive("com.unknown.factoryunk.commands")) {
                ...
                if (classz != null && !classz.isAnnotation() && !classz.isEnum() && FineCommand.class.isAssignableFrom(classz) && !classz.equals(FineCommand.class)) {
                    Constructor<?> constructor = ReflectionUtil.getConstructor(classz);
                    if (constructor != null) {
                        ReflectionUtil.newConstructorInstance(constructor);
                    }
                }
            }
        } catch (Exception ew) {
